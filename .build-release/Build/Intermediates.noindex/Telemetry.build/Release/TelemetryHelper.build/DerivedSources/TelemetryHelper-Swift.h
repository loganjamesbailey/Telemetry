...
#ifndef TELEMETRYHELPER_SWIFT_H
#define TELEMETRYHELPER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TelemetryHelper",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15TelemetryHelper10HelperTool")
@interface HelperTool : NSObject <NSXPCListenerDelegate, TelemetryHelperProtocol>
